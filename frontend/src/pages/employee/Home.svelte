<script> 
    ...
    let flag_iddepartement_field = false;
    ...
    const NewData = (e,id,idepartement,name,alamat,email,phone1,phone2,status,create,update) => {
        sData = e
        if(sData == "New"){
            clearField()
        }else{
            flag_id_field = true;
            idrecord = id;
            flag_iddepartement_field = false;
            iddepartement_field = idepartement;
            name_field = name;
            alamat_field = alamat;
            email_field = email;
            phone1_field = phone1;
        ...
        if(flag){
            ...
            const res = await fetch("/api/employeesave", {
                ...
                body: JSON.stringify({
                    sdata: sData,
                    page:"CURR-SAVE",
                    employee_search: searchHome,
                    employee_page: parseInt(pagingnow),
                    employee_id: idrecord,
                    employee_iddepartement: iddepartement_field,
                    employee_name: name_field,
                    employee_alamat: alamat_field,
                    employee_email: email_field,
                    employee_phone1: phone1_field,
                    employee_phone2: phone2_field,
                            ...
                            {#each filterHome as rec }
                                <tr>
                                    <td NOWRAP style="text-align: center;vertical-align: top;cursor:pointer;">
                                        <i on:click={() => {
                                            //e,id,idepartement,name,alamat,email,phone1,phone2,status,create,update
                                                NewData("Edit",rec.home_id, rec.home_iddepartement,rec.home_name,
                                                rec.home_alamat,rec.home_email,rec.home_phone1,rec.home_phone2,rec.home_status,
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <select
                        ...
                        disabled={flag_iddepartement_field} 
                ...
                <div class="mb-3">
                    ...
                    <textarea 
                        style="height: 100px;resize: none;" bind:value={alamat_field} class="form-control required"/>
                </div>
            </div>
            <div class="col-md-6">
                <div class="mb-3">
