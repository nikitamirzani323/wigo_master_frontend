<script>
    ...
    const NewData = (e,id,tipe,name,status,create,update) => {
        sData = e
        if(sData == "New"){
            clearField()
        }else{
                    ...
                    <table class="table table-striped ">
                        <thead>
                            <tr>
                                ...
                                <th NOWRAP width="15%" style="text-align: left;vertical-align: top;font-weight:bold;font-size: {table_header_font};">TIPE</th>
                            ...
                            {#each filterHome as rec }
                                <tr>
                                    <td NOWRAP style="text-align: center;vertical-align: top;cursor:pointer;">
                                        <i on:click={() => {
                                                //e,id,tipe,name,status,create,update
                                                NewData("Edit",rec.home_id, rec.home_tipe ,rec.home_name, rec.home_status ,rec.home_create, rec.home_update);
