                ...
                for (var i = 0; i < record.length; i++) {
                    ...
                    listHome = [
                        ...listHome,
                        {
                            ...
                            home_idemployee: record[i]["purchaserequest_idemployee"],
                            home_nmbranch: record[i]["purchaserequest_nmbranch"],
                            home_nmdepartement: record[i]["purchaserequest_nmdepartement"],
                            home_nmemployee: record[i]["purchaserequest_nmemployee"],
                            home_tipedoc: record[i]["purchaserequest_tipedoc"],
                            home_remark: record[i]["purchaserequest_remark"],
                            home_totalitem: record[i]["purchaserequest_totalitem"],
                            home_totalpr: record[i]["purchaserequest_totalpr"],
                            home_totalpo: record[i]["purchaserequest_totalpo"],
                            home_status: record[i]["purchaserequest_status"],
                            home_status_css: record[i]["purchaserequest_status_css"],
                            home_create: record[i]["purchaserequest_create"],
                            home_update: record[i]["purchaserequest_update"],
                        },
                    ];
                }
                listPage = [];
